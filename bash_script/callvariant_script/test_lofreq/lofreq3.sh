...
out=/home/ndo/bash_output/04_callvariant_vcf/test_lofreq/3.vcf

# set the qual lower than 6 (0)
lofreq call-parallel --pp-threads 12 --no-default-filter -A -B -a 1 -b 1 -q 0 -Q 0 --min-cov 1 -f $ref -l $bed \
-o $out $bam