...
lofreq call-parallel --pp-threads 12 --no-default-filter -B -q 3 -Q 3 -a 1 -b 1 -f $ref -l $bed -o /home/ndo/bash_output/04_callvariant_vcf/SRR13586007_lofreq.vcf $bam